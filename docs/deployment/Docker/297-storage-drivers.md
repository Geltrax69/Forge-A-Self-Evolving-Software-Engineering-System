...
> Note
>
> This page describes the classic storage drivers, such as `overlay2`. Docker Engine 29.0 and later uses the [containerd image store](https://docs.docker.com/engine/storage/containerd/) by default for fresh installations, which uses snapshotters instead of classic storage drivers. If you're running a fresh installation of Docker Engine 29.0 or later, or if you've migrated to the containerd image store, the concepts on this page still explain how image layers work, but the commands and examples won't reflect how your system stores images. For operational guidance, see [containerd image store](https://docs.docker.com/engine/storage/containerd/).
