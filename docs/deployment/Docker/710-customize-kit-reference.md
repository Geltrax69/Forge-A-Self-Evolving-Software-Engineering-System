url: https://docs.docker.com/ai/sandboxes/customize/kit-reference/
----
...
This page documents every field in a kit's `spec.yaml`. For an overview of what kits are and how to use them, see [Kits](https://docs.docker.com/ai/sandboxes/customize/kits/).
...
The sections below apply to both kinds. Sandbox kits also declare a [`sandbox:` block](#sandbox-block).
