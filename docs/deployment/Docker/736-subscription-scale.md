...
## [Add DHI Select to organization accounts](#add-dhi-select-to-organization-accounts)
...
5. Select **Add repositories**, then add the number of new repositories you want to add to the account.
...
To learn more about DHI Select, see [Get started with DHI Select and Enterprise](https://docs.docker.com/dhi/how-to/select-enterprise/). Purchasing eight or more hardened repositories? [Contact Docker sales](https://www.docker.com/pricing/contact-sales/) to discuss an Enterprise plan.

## [Add a Gordon Plus, Max, or Ultra plan to personal accounts](#add-a-gordon-plus-max-or-ultra-plan-to-personal-accounts)

> Important
>
> Gordon subscriptions apply to personal Docker accounts only. If you purchase a Gordon plan while signed in with an organization account, the subscription applies to your personal account automatically.
...
2. Select **Billing**, then **Browse products**.
3. Select **View plans** from the **Upgrade Gordon** section of the products page.
4. Choose the Gordon subscription plan you want to apply to your personal account.
...
2. Select **Upgrade plan** and choose the new plan you want to upgrade to.
3. Verify your billing details, continue to payment, and complete checkout.

To learn about Gordon usage, see [Gordon usage limits and tiers](https://docs.docker.com/ai/gordon/usage-limits/).

## [Add licenses](#add-licenses)

Licenses add a layer to your Docker subscriptions, letting you assign products to select members of your organization without consuming a Docker Core seat. You can purchase licenses for some Docker products:

* AI Governance
* Docker Offload

Once you've purchased licenses for your organization, you can [manage license assignment](https://docs.docker.com/admin/organization/manage/manage-licenses/) from the **Members** page in Docker Home.

> Tip
>
> To purchase licenses for AI Governance and Docker Offload, [contact sales](https://www.docker.com/pricing/contact-sales/).

### [AI Governance licenses](#ai-governance-licenses)
...
### [Docker Offload licenses](#docker-offload-licenses)
...
### [Docker Build Cloud build minutes](#docker-build-cloud-build-minutes)
...
### [Docker Testcontainers Cloud runtime minutes](#docker-testcontainers-cloud-runtime-minutes)
...
* [Manage licenses](https://docs.docker.com/admin/organization/manage/manage-licenses/)
* [Manage seats](https://docs.docker.com/admin/organization/manage/manage-seats/)
* [View your consumption](https://docs.docker.com/admin/organization/manage/manage-products/#monitor-product-usage-for-your-organization)
