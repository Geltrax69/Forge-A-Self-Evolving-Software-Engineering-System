...
> Note
>
> If you're deploying to a Kubernetes cluster outside of Docker Desktop, you'll need to create an image pull secret and reference it in your pod specs. See [Use a Docker Hardened Image](/dhi/how-to/use/#use-with-kubernetes) for instructions.
...
1. In a terminal, navigate to `python-docker-example` and deploy your database to Kubernetes.
