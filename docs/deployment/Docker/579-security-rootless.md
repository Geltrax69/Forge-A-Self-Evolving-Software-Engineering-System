...
The two modes also differ in how they map container UIDs and GIDs to the host: see [UID/GID mapping](https://docs.docker.com/engine/security/rootless/uid-gid-mapping/) for details.
