...
```
/data/nginx/cache/c/29/b7f54b2df7773722d382f4809d650297c
```
...
**Default:** `proxy_request_dynamic off;`
...
Specifies a `file` with revoked certificates (CRL) in the PEM format used to verify the certificate of the proxied HTTPS server. When using intermediate certificates, their CRLs should be specified in the same file.
